...
namespace ActorBackendServiceNetCore
{
    ...
    internal class NetCoreActor : Actor, INetCoreActor
    {
        private const string StateNameCount = "NetCoreActor_count";

        /// <summary>
        /// Initializes a new instance of ActorBackendServiceNetCore
        /// </summary>
        /// <param name="actorService">The Microsoft.ServiceFabric.Actors.Runtime.ActorService that will host this actor instance.</param>
        /// <param name="actorId">The Microsoft.ServiceFabric.Actors.ActorId for this actor instance.</param>
        public NetCoreActor(ActorService actorService, ActorId actorId)
        ...
        {
            ActorEventSource.Current.ActorMessage(this, "NetCoreActor activated.");
            ...
            return StateManager.TryAddStateAsync(StateNameCount, 0);
        }
