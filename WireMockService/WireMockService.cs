...
namespace WireMockService
{
    ...
    /// </summary>
    internal sealed class WireMockService : StatefulService
    {
        public WireMockService(StatefulServiceContext context) : base(context)
        {
        }
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            {
                new ServiceReplicaListener(serviceContext => new WireMockCommunicationListener(serviceContext, StateManager))
            };
        }
